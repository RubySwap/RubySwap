...
import "@rubyswap/ruby-swap-lib/contracts/token/BEP20/BEP20.sol";

import "./RubyToken.sol";

// GemMine with Governance.
contract GemMine is BEP20('GemMine Token', 'GEM') {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (MasterJeweler).
    ...
    function safeRubyTransfer(address _to, uint256 _amount) public onlyOwner {
